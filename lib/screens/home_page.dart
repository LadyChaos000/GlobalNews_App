...
import 'package:news_app/screens/view_all_news.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> const SearchArticles()),);
            },
          ),
        ],
      ),
  ...
  Widget buildIndicator() => AnimatedSmoothIndicator(
        ...
        effect: const SlideEffect(
            dotWidth: 10, dotHeight: 10, activeDotColor: Colors.indigoAccent),
      );
}
